    ...
    <div class="stats-grid-main">
        <div class="stat-card student-card">
            ...
            <div class="stat-content">
                <div class="stat-number">{{ $totalStudents ?? 1,250 }}</div>
        ...
        <div class="stat-card staff-card">
            ...
            <div class="stat-content">
                <div class="stat-number">{{ $totalTeachers ?? 85 }}</div>
        ...
        <div class="stat-card fee-card">
            ...
            <div class="stat-content">
                <div class="stat-number">${{ number_format($pendingFees ?? 12500) }}</div>
        ...
        <div class="stat-card leave-card">
            ...
            <div class="stat-content">
                <div class="stat-number">{{ $pendingLeaves ?? 8 }}</div>
        ...
        <div class="left-column">
                ...
                <div class="chart-header">
                    ...
                    <div class="chart-legend">
                        <span class="legend-item">
                            <span class="legend-color current"></span> Current Year
                        </span>
                        <span class="legend-item">
                            <span class="legend-color previous"></span> Previous Year
                        </span>
                    </div>
                </div>
            ...
            <div class="chart-card">
                <div class="chart-header">
                    ...
                    <span class="chart-percentage">{{ $feeCollectionRate ?? 75 }}% Collected</span>
                </div>
                <div class="progress-container">
                    <div class="progress-bar">
                        <div class="progress-fill" style="width: {{ $feeCollectionRate ?? 75 }}%"></div>
                    </div>
                    <div class="progress-stats">
                        <span>Collected: ${{ number_format($collectedFees ?? 37500) }}</span>
                        <span>Pending: ${{ number_format($pendingFees ?? 12500) }}</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="right-column">
            ...
            <div class="activity-card">
                ...
                <div class="activity-list">
                    ...
                    <div class="activity-item">
                        ...
                        <div class="activity-content">
                            <p>Fee payment received - Sarah Smith</p>
                    ...
                    <div class="activity-item">
                        ...
                        <div class="activity-content">
                            <p>Leave application submitted - Mr. Johnson</p>
                    ...
                    <div class="activity-item">
                        ...
                        <div class="activity-content">
                            <p>New teacher assigned - Mathematics</p>
            ...
            <div class="leaves-card">
                <div class="leaves-header">
                    ...
                    <span class="badge">{{ $pendingLeaves ?? 8 }}</span>
                </div>
                <div class="leaves-list">
                    ...
                    <div class="leave-item">
                        ...
                        <div class="leave-details">
                            <h4>{{ ['John Doe', 'Mary Smith', 'Alex Khan'][$i] }}</h4>
                            <p>{{ ['Sick Leave', 'Personal Leave', 'Emergency Leave'][$i] }}</p>
                            <span class="leave-date">Dec 15 - Dec 18</span>
                        </div>
        ...
        <div class="events-grid">
            <div class="event-card">
                ...
                <div class="event-details">
                    ...
                    <p>School Ground • 9:00 AM</p>
                </div>
                <div class="event-badge primary">Sports</div>
            </div>
            <div class="event-card">
                <div class="event-date">
                ...
                <div class="event-details">
                    ...
                    <p>Main Hall • 2:00 PM</p>
                </div>
                <div class="event-badge success">Meeting</div>
            </div>
            <div class="event-card">
                <div class="event-date">
                ...
                <div class="event-details">
                    ...
                    <p>Auditorium • 10:00 AM</p>
                </div>
                <div class="event-badge warning">Holiday</div>
            </div>
        </div>
    </div>
</div>
