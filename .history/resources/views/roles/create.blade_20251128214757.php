    ...
    <div class="section">
        <form action="{{ route('roles.store') }}" method="POST" id="role-form">
            ...
            <div class="form-row">
                <div class="form-col">
                    <div class="form-group">
                        ...
                        <input type="text" name="name" class="form-control" value="{{ old('name') }}" placeholder="e.g., Teacher, Accountant, etc." required>
                        @error('name')
            ...
            <div class="form-group">
                ...
                <textarea name="description" class="form-control" rows="3" placeholder="Describe the role and its responsibilities..." required>{{ old('description') }}</textarea>
                @error('description')
                    <div class="text-danger" style="font-size: 0.875rem;">{{ $message }}</div>
                @enderror
            </div>
