    ...
    <div class="dashboard-cards" style="margin-bottom: 30px;">
        <div class="card">
            <div class="card-header">
                <div>
                    <div class="card-stats">{{ $leaves->where('status', 'pending')->count() }}</div>
        ...
        <div class="card">
            <div class="card-header">
                <div>
                    <div class="card-stats">{{ $leaves->where('status', 'approved')->count() }}</div>
        ...
        <div class="card">
            <div class="card-header">
                <div>
                    <div class="card-stats">{{ $leaves->where('status', 'rejected')->count() }}</div>
